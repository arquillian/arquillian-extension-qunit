    ...
    public void waitUntilTestsExecutionIsCompleted() {
        try {
            ...
            LOGGER.log(Level.SEVERE,
                "## Error: waitUntilTestsExecutionIsCompleted: Suite was not completed within 2 minutes");
        }
    }
            ...
            if (!CollectionUtils.isEmpty(qunitSuiteResults)) {
                ...
                for (List<Object> qunitTestResultsList : qunitSuiteResults) {
                    if (!CollectionUtils.isEmpty(qunitTestResultsList)) {
                        ...
                        @SuppressWarnings("unchecked") final List<String> failedAssertionCauseList =
                            (List<String>) qunitTestResultsList.get(5);
                        ...
                        final QUnitTest qunitTestResult =
                            (new QUnitTestImpl()).setModuleName(moduleName).setName(testName)
